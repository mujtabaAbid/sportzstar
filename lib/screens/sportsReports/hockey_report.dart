...
class HockeyWidget extends StatefulWidget {
  const HockeyWidget({super.key});

  @override
  State<HockeyWidget> createState() => _HockeyWidgetState();
}

class _HockeyWidgetState extends State<HockeyWidget> {
